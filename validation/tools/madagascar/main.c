...
#include "zPRINTDATE"
  ...
  if(argc == 1) {
    ...
    printf("-A n   Run algorithm A with parameter n (range 1 to 50)  (see Rintanen ECAI'04).\n");
    printf("-B r   Run algorithm B with parameter r (range 0.1 to 0.9999, default -B %.2f).\n",paramB);
